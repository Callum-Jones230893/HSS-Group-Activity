...
const BecomeALeader = () => {
  ...
  return (
    <div className="flex flex-col bg-primary ">
      <div className="flex flex-start flex-col px-4  lg:px-14 lg:py-12">
      ...
      <img
        ...
        className="py-9 lg:w-screen"
      />
        <p className=" font-primary text-left text-white  lg:max-w-313.5 text-[18px] lg:text-[24px] leading-[31.5px] lg:leading-10.5 tracking-[0.18px] lg:tracking-[0.24px] pb-10 px-4 lg:px-36.5">{data.descriptionOne}
          <br/>
          <br/>
          {data.descriptionTwo}
          <br/>
