...
const Navigation = () => {
  ...
  return (
    <div className='flex justify-end items-center gap-2 text-primary md:flex-row-reverse md:justify-center md:gap-8'>
      ...
      <nav className="font-primary text-primary">
        ...
        <div
          className={`${hamburger ? "flex" : "hidden"} flex-col gap-6 mt-4
      md:flex md:flex-row md:items-center md:justify-center md:gap-8 md:mt-0`}>
          ...
          <div className="relative">
            <button type="button" onClick={() => setOpenMore(prev => !prev)} className="flex items-center gap-1">
            ...
            {openMore && (
              <div className="absolute left-0 flex min-w-55 flex-col">
