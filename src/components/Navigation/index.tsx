...
const Navigation = ({ className }: NavOrderProp) => {
  ...
  return (
    <nav
      className={`relative font-primary  text-primary lg:w-2/3 lg:mx-auto ${className}`}
    >
      <div
        className={`fixed inset-0 bg-primary/70 lg:hidden backdrop-blur-sm transition-opacity duration-300
