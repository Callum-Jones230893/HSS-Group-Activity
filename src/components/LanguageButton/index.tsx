    ...
    <div ref={localeRef} className="relative flex justify-end items-center lg:justify-center w-full lg:w-auto ">
      <button type="button" onClick={() => setOpenLocale(prev => !prev)} className="cursor-pointer">
        <svg
          ...
          viewBox="0 0 24 24"
          fill="none"
          className={`transition-transform duration-350 ${openLocale ? "rotate-180" : "rotate-0"}`}>
          <path
      ...
      {openLocale && (
        <div className="bg-white flex flex-col gap-4 top-8 p-4 justify-center items-center w-16 absolute">
