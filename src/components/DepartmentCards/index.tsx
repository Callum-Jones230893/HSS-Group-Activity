...
const DepartmentCards = ({item}: DepartmentItemProps) => {
  ...
  return (
    <div className={`xl:flex flex-col xl:flex-row items-center rounded-lg xl:rounded-2xl lg:border-l-[3px] 
      lg:border-r-[0.50px] lg:border-t-[0.50px] lg:border-b-[3px] lg:border-${} mb-21.75 font-primary text-lg xl:text-2xl p-8
      outline-[0.50px] outline-offset-[-0.50px] outline-${} inline-flex`}
    >
      ...
      <div className="flex flex-col my-3 xl:mx-11.5 justify-evenly">
        <div className="flex items-center gap-1.5">
          ...
          <p className={`font-bold text-1xl text-${}`}>{item.subtitle}</p>
        </div>
