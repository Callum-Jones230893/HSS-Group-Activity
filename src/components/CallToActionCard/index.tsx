...
const CallToActionCard = ({item}: CallToActionProps) => {
  return (
    <div className="flex flex-col max-w-9/10 mx-auto h-fit text-primary font-primary p-4 odd: lg:mb-10 xl:flex-row 
        xl:mx-14.75 my-10 lg:justify-center lg:item-center xl:even:flex-row-reverse gap-28"
    >
      ...
      <div className="flex justify-center mx-auto mt-10 lg:mx-auto w-9/10 lg:w-7/10 xl:w-4/10 max-w-150 aspect-4/3">
