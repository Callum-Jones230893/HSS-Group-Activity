...
const Hero = ({ title, intro, image, button }: HeroProps) => {
  return (
    <div className="bg-primary">
      <div className="max-w-432 mx-auto px-4 md:px-36.75 pt-6 pb-10 md:py-12 lg:py-12 flex flex-col lg:flex-row gap-8 lg:items-center">
        ...
        {image && (
          <Image
            ...
            width={471}
            height={471}
            className="hidden md:block object-cover w-80 h-80 rounded-2xl"
          />
        )}
      </div>
    </div>
