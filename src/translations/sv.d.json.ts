...
declare const messages: {
  ...
  "becomealeader": {
    ...
    "subtitle": "Här kanske ditt livs äventyr startar. I HSS finns det spännande utmaningar för stor som liten.",
    ...
    "descriptionThree": "”Scouterna har varit min bästa ledarskola. Där kan man bara leda med idéns kraft och förmågan att övertyga.” ",
    "quoteOne":"[Carl-Henrik Svanberg, fd VD för Ericsson, i Expressen 2003-02-07]",
